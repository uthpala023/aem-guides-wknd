...
(function() {
    ...
    // interact with.
    var selectors = {
        self:      '[data-cmp-is="threecards"]',
        property:  '[data-cmp-hook-threecards="property"]',
        message:   '[data-cmp-hook-threecards="model"]'
    };
    ...
    function onDocumentReady() {
        ...
        for (var i = 0; i < elements.length; i++) {
            new HeroBanner({ element: elements[i] });
        }
                    ...
                    nodesArray.forEach(function(addedNode) {
                        if (addedNode.querySelectorAll) {
                            ...
                            elementsArray.forEach(function(element) {
                                new HeroBanner({ element: element });
                            });
                        }
                    });
                }
